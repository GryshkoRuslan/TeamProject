...
const filtersAttributesForCategories = (categoryID) => {
    ...
    if (categoryName == 'smartphones') {
        return {categoryName: categoryName[0], ids: [1,2,3,5,6,7,9,10,11,13,15,18]}
    } else if (categoryName == 'tablets') {
        return {categoryName: categoryName[0], ids: [1,2,3,5,6,9,10,11,13,15]}
    } else if (categoryName == 'laptop') {
        return {categoryName: categoryName[0], ids: [1,2,3,5,6,9,15,17,22,29,30,31,32,33,34,40,41]}
